...
namespace Covaccin.web.Controllers
{
    public class PersonnesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nom,Prenom,Sexe,DateNaissance,EstResident_pasPersonnel")] Personne personne)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nom,Prenom,Sexe,DateNaissance,EstResident_pasPersonnel")] Personne personne)
        {
            if (id != personne.Id)
            {
                return NotFound();
